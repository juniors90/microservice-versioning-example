...
class NoteTestCase(BaseTestClass):
    ...
    def test_person_bad_request(self):
        ...
        response = self.client.post(
            "/api/v1/notes", headers=self.get_api_headers(), json=data
        )
    ...
    def test_read_one(self):
        ...
        response = self.client.get(f'/api/v1/notes/{data["id"]}')
    ...
    def test_delete_note(self):
        ...
        response = self.client.delete(f"/api/v1/notes/3")
    ...
    def test_delete_not_exist(self):
        ...
        response = self.client.delete(f'/api/v1/notes/{data["id"]}')
        self.assertEqual(response.status_code, 404)
        self.assertIn(b"Note with ID 20 not found", response.data)
